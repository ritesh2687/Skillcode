...
import { BadgeInfo, CloudCog, Loader2, PlayCircle } from "lucide-react";
...
const CourseDetail = () => {
    ...
    if (isLoading) return <h1><Loader2 />Loading</h1>
                ...
                <div className="w-full lg:w-1/3">
                    <Card>
                        ...
                        <CardFooter className="flex justify-center p-4">
                            {
                                purchased ? (<Button onClick={handleCountinueCourse} className="w-full">Countinue Course</Button>) : (<BuyCourseButton courseId={courseId} />)
                            }
