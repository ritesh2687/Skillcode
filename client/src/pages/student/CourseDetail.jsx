        ...
        <div className="mt-20 space-y-15">
            <div className="bg-[#2D2F31] text-white">
                <div className="max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2">
                    ...
                    <p>
                        Created By{" "}
                        <span className="text-[#C0C4FC] underline italic">patel babu</span>
                    </p>
            ...
            <div className="max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-10">
                <div className="w-full lg:1/2 space-y-5">
                    ...
                    <p className="text-sm">
                        ...
                        laborum aliquam voluptates pariatur, mollitia non.
                    </p>
                    <Card>
                        <CardHeader>
                ...
                /> */}
                        ...
                        <CardFooter className="flex justify-center p-4">
                            {
                                purchasedCourse ? (<Button className="w-full">Countinue Course</Button>) : (<BuyCourseButton courseId={courseId}/>)
                            }
